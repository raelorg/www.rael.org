...
// ----------------------------------------------------
add_filter( 'gform_pre_render_20', 'pre_render_20' );
function pre_render_20( $form ) {
...
// -----------------------------------------------------
add_filter( 'gform_notification_20', 'notification_20', 10, 3 );
function notification_20( $notification, $form, $entry ) {
