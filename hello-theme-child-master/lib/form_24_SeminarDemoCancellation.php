...
// ----------------------------------------------------
add_filter( 'gform_pre_render_24', 'pre_render_24' );
function pre_render_24( $form ) {
                ...
                case 2: // Email
                    ...
                    <script type="text/javascript">
                        jQuery(document).ready(function(){
                            jQuery("#input_24_2").attr("readonly", "readonly");
                        });
                    </script>
                    <?php
                    break;
...
// -----------------------------------------------------
add_filter( 'gform_notification_24', 'notification_24', 10, 3 );
function notification_24( $notification, $form, $entry ) {
	...
	if ( $notification['toType'] === 'field' ) {
		...
		$confirmation = SelectNotification(24, 'person', $language_iso);
