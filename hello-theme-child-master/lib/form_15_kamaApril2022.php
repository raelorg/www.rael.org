...
// ----------------------------------------------------
// Form : Kama April 2022 (15)
// > Pre-populate the form
// ----------------------------------------------------
add_filter( 'gform_pre_render_15', 'pre_render_15' );
function pre_render_15( $form ) {
				...
				if ( $found ) {
    				...
    				<script type="text/javascript">
        				jQuery(document).ready(function(){
							jQuery("#input_15_2").attr("readonly", "readonly");
							jQuery("#input_15_2_2").attr("readonly", "readonly");
        				});
    				</script>
    				<?php
				}
...
// -----------------------------------------------------
add_filter( 'gform_notification_15', 'notification_15', 10, 3 );
function notification_15( $notification, $form, $entry ) {

	$page_cancel = 'Registration cancellation';
	$message = rgar ( $entry, '6' );
	$selected_meal = rgar( $entry, '7' );
	$selected_hotel = rgar( $entry, '8' );
	...
	$year = '2022';                 // Year
	$page_title = 'Kama 2022';     // Title of the web page
	...
	if ( $notification['toType'] === 'email' ) {
		...
		$html = str_replace('field-repas-7', $selected_meal, $html );
		$html = str_replace('field-hotel-8', $selected_hotel, $html );
