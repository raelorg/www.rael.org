...
// ----------------------------------------------------
// Form : Event Cancellation (19)
// > Pre-populate the form
// ----------------------------------------------------
add_filter( 'gform_pre_render_19', 'pre_render_19' );
function pre_render_19( $form ) {
                ...
                case 2: // Email
                    ...
                    <script type="text/javascript">
                        jQuery(document).ready(function(){
                            jQuery("#input_19_2").attr("readonly", "readonly");
                        });
                    </script>
                    <?php
                    break;
...
// -----------------------------------------------------
add_filter( 'gform_notification_19', 'notification_19', 10, 3 );
function notification_19( $notification, $form, $entry ) {
	...
	if ( $notification['toType'] === 'field' ) {
		...
		$confirmation = SelectNotification(19, 'confirmation', $language_iso);
