...
add_filter( 'gform_pre_render_47', 'pre_render_47' );
function pre_render_47( $form ) {
...
// -----------------------------------------------------
add_filter( 'gform_notification_47', 'notification_47', 10, 3 );
function notification_47( $notification, $form, $entry ) {
